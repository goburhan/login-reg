	...
	return (
		...
		<div>
			<div className={classnames({ 'field-label-wrapper': ishorizontalfield })}>
				{/* <div className="d-flex"> ////////////  inside of input
					{label && (
				...
				<div className={classnames('field-content')}>
					...
					{!hideUnderline && (
						<span
							className={classnames(outlineClassName, {
								focused,
							})}
						/>
					)}
			...
			<div className="field-label-wrapper fixed">
				{ishorizontalfield ? (
					<Fragment>
...
export const FieldError = ({ error, displayError, className, stringId }) => (
	<div
		...
		className={classnames('field-error-content fixed', className, {
